...
const EngineOptions = () => {
  ...
  return (
    <div className="flex md:flex-col max-h-[30%] min-h-36 md:w-72 border-t md:border-t-0 md:border-l border-zinc-400 dark:border-zinc-800">
      ...
      <div className="md:flex-1 md:h-1/2 border-r md:border-r-0 md:border-b border-zinc-400 dark:border-zinc-800">
        <ScrollArea className="h-[100%] w-full p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 content-start gap-4">
      ...
      <div className="md:flex-1 md:h-1/2">
        <ScrollArea className="h-[100%] w-full p-4">
          <MaterialOptions />
        </ScrollArea>
      </div>
